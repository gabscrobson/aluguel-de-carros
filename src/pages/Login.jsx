        ...
        <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <button
              ...
              className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 hover:shadow-xl transition duration-300'}`}
            >
              {isSigningIn ? 'Logando...' : 'Logar'}
            </button>
          </form>
          ...
          >
            ...
            {isSigningIn ? 'Logando...' : 'Continuar com Google'}
          </button>
        </div>
      </main>
    </div>
